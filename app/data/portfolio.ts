...
export const portfolioData = {
  ...
  stats: [
    ...
    { value: "08", label: "Completed certificates" },
  ],
  practicalWork: [
    {
  ...
  certifications: [
    {
      ...
      imageEn: "/certificates/previews/java-programming-1-en.webp",
      imageAr: "/certificates/previews/java-programming-1-ar.webp",
      tag: "Java",
    },
    {
      code: "CERT / 02",
      ...
      imageEn: "/certificates/previews/cyber-security-basics-en.webp",
      imageAr: "/certificates/previews/cyber-security-basics-ar.webp",
      tag: "Security",
    },
    {
      code: "CERT / 03",
      ...
      imageEn: "/certificates/previews/ai-generative-ai-en.webp",
      imageAr: "/certificates/previews/ai-generative-ai-ar.webp",
      tag: "AI",
    },
    {
      code: "CERT / 04",
      ...
      imageEn: "/certificates/previews/cyber-security-career-path.webp",
      imageAr: "/certificates/previews/cyber-security-career-path.webp",
      tag: "Career",
    },
    {
      code: "CERT / 05",
      ...
      imageEn: "/certificates/previews/cyber-attack-techniques-en.webp",
      imageAr: "/certificates/previews/cyber-attack-techniques-ar.webp",
      tag: "Security",
    },
    {
      code: "CERT / 06",
      ...
      imageEn: "/certificates/previews/protect-systems-from-penetrations-en.webp",
      imageAr: "/certificates/previews/protect-systems-from-penetrations-ar.webp",
      tag: "Defense",
    },
    {
      code: "CERT / 07",
      ...
      imageEn: "/certificates/previews/introduction-to-cyber-security-en.webp",
      imageAr: "/certificates/previews/introduction-to-cyber-security-ar.webp",
      tag: "Security",
    },
    {
      code: "CERT / 08",
      issuer: "Edraak & Crescent Petroleum",
      date: "24 Aug 2026",
      fileEn: "/certificates/ai-workplace-tools-practical-applications.pdf",
      fileAr: "/certificates/ai-workplace-tools-practical-applications-ar.pdf",
      imageEn: "/certificates/previews/ai-workplace-tools-en.webp",
      imageAr: "/certificates/previews/ai-workplace-tools-ar.webp",
      tag: "AI Tools",
    },
  ],
  projects: [
    {
      ...
      imageEn: "/projects/alasema-restaurant-en.webp",
      imageAr: "/projects/alasema-restaurant-ar.webp",
      live: "https://alasema-rest.vercel.app",
    },
    {
      name: "Shahd Falyouna Portfolio",
      number: "02",
      description: "A bilingual portfolio for an Artificial Intelligence and Data Science student, presenting education, skills, projects, and contact information in a responsive interface.",
      tags: ["Next.js", "TypeScript", "Bilingual UI", "Responsive Design"],
      imageEn: "/projects/shahd-falyouna-en.webp",
      imageAr: "/projects/shahd-falyouna-ar.webp",
      live: "https://shahd-falyouna.vercel.app",
    },
    {
      name: "Dev Nexus Academy",
      number: "03",
      description: "A bilingual technical learning platform that organizes courses, books, articles, and roadmaps across programming, security, data, and cloud topics.",
      tags: ["Next.js", "TypeScript", "Laravel API", "Arabic RTL"],
      imageEn: "/projects/dev-nexus-academy-en.webp",
      imageAr: "/projects/dev-nexus-academy-ar.webp",
      live: "https://dev-nexus-academy.vercel.app",
    },
  ],
